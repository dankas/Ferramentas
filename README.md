...
Os scripts de instalação executam o comando LPADMIN para instalar as impressoras pelo CUPS no Linux e MACos. Ambos precisam de permissão completa para usuario(CHMOD 700).
